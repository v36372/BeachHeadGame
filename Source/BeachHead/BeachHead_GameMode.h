...
#include "BeachHead_GameMode.generated.h"

/**
 * 
 */
UCLASS()
class BEACHHEAD_API ABeachHead_GameMode : public AGameMode
{
	GENERATED_BODY()
...
public:
	...
	virtual bool CanDealDamage(class ABeachHeadPlayerState* DamageCauser, class ABeachHeadPlayerState* DamagedPlayer) const;
