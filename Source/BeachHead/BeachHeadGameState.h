...
#include "BeachHeadGameState.generated.h"

/**
 * 
 */
UCLASS()
class BEACHHEAD_API ABeachHeadGameState : public AGameState
{
	GENERATED_BODY()
...
public:
	...
	ABeachHeadGameState(const class FObjectInitializer& ObjectInitializer);
